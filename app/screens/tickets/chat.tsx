...
export default function ChatScreen() {
  const openWhatsApp = () => {
    const phoneNumber = '1234567890'; // Replace with actual control room number
    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="flex-1 px-4">
        ...
        <View className="mb-4">
          ...
          <Text className="text-base">Phone: +1 (234) 567-8900</Text>
          <Text className="text-base">Email: control@company.com</Text>
