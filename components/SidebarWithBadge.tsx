...
const menuItems = [
  ...
  { label: 'Trips', icon: 'car-outline', route: '/screens/trips', showBadge: false },
  { label: 'Settings', icon: 'settings-outline', route: '/screens/profile/profile', showBadge: false },
...
export default function Sidebar({ isVisible, onClose, devicesNeedingAttention = 0 }: SidebarProps) {
